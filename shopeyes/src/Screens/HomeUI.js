...
function HomeUI() {
    ...
    const speechResultsHandler = (e) => {
        ...
        else if (text.toLowerCase() === "guide" || text.toLowerCase() === "instructions" || text.toLowerCase() === "instruction") {
    ...
    return (
        <View style={styles.container}>
            ...
            <View style={styles.tileRow}>
                {/* Button 1: Add Icon */}
                <TouchableOpacity style={styles.tileButton} onPress={() => navigation.navigate('Create Item List')}>
                    <Icon name="cart-plus" size={64} color="yellow" />
                    <Text style={styles.tileButtonText}>SHOPPING CART</Text>
                </TouchableOpacity>

                {/* Button 2: Star Icon */}
                <TouchableOpacity style={styles.tileButton} onPress={() => navigation.navigate('Regular Shopping')}>
                    <Icon name="bolt" size={64} color="yellow" />
                    <Text style={styles.tileButtonText}>INSTANT SHOPPING</Text>
                </TouchableOpacity>
            </View>
            ...
            <View style={styles.tileRow}>
                ...
                <TouchableOpacity style={styles.tileButton} onPress={() => navigation.navigate('Support Centre')}>
                    <Icon name="hands-helping" cog size={64} color="yellow" />
                    <Text style={styles.tileButtonText}>SUPPORT</Text>
                </TouchableOpacity>

                {/* Button 4: Customize this button */}
                <TouchableOpacity style={styles.tileButton} onPress={() => navigation.navigate('Guide')}>
                    <Icon name="book-reader" size={64} color="yellow" />
                    <Text style={styles.tileButtonText}>GUIDE</Text>
                </TouchableOpacity>
            </View>
